use super::common::boilerplate_w;
use crate::{
...
fn event<T: Tracer, W>(
    ...
    boilerplate_w::<opcodes::Event, _, _>(vm, world, tracer, |vm, args, _| {
...
fn l2_to_l1<T: Tracer, W>(
    ...
    boilerplate_w::<opcodes::L2ToL1Message, _, _>(vm, world, tracer, |vm, args, _| {
        let key = Register1::get(args, &mut vm.state);
        let value = Register2::get(args, &mut vm.state);
